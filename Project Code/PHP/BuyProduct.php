...
.row 
{
    background-color:#C7EFB7;
}
h2
{
  background-color:#75F83F;
}
a 
{
   padding: 5px;
...
<body>
<div class="container">
  <h2 class="text-center">You Can Buy Any Product</h2>
  <div class="row">
...
<form action="BuyProduct.php" method="post" enctype="multipart/form-data">
